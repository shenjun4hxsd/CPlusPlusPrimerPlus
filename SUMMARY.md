...
* 第15章 友元、异常和其他
    ...
    * 15.7 复习题
    * 15.8 编程练习
* [第16章 string 类和标准模版库](第16章-string-类和标准模版库.md)
    * [16.1 string 类](161-string-类.md)
        * [16.1.1 构造字符串](1611-构造字符串.md)
        * [16.1.2 string 类输入](1612-string-类输入.md)
        * [16.1.3 使用字符串](1613-使用字符串.md)
        * [16.1.4 string 还提供了哪些功能](1614-string-还提供了哪些功能.md)
        * [16.1.5 字符串种类](1615-字符串种类.md)
    * [16.2 智能指针模版类](162-智能指针模版类.md)
        * 16.2.1 使用智能指针
        * 16.2.2 有关智能指针的注意事项
        * 16.2.3 unique\_ptr 为何优于 auto\_ptr
        * 16.2.4 选择智能指针
    * [16.3 标准模版库](163-标准模版库.md)
        * [16.3.1 模版类 vector](1631-模版类-vector.md)
        * [16.3.2 可对矢量执行的操作](1632-可对矢量执行的操作.md)
        * [16.3.3 对矢量可执行的其他操作](1633-对矢量可执行的其他操作.md)
        * [16.3.4 基于范围的 for 循环（C++11）](1634-基于范围的-for-循环（c11）.md)
    * [16.4 泛型编程](164-泛型编程.md)
        * 16.4.1 为何使用迭代器
        * 16.4.2 迭代器类型
        * 16.4.3 迭代器层次结构
        * 16.4.4 概念、改进和模型
