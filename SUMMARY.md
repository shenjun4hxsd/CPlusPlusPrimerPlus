...
* [第2章 开始学习  C++](第2章-开始学习-c.md)
    * [2.1 进入 C++](21-进入-c.md)
        ...
        * 2.1.7 C++ 源代码的格式化
    * [2.2 C++ 语句](22-c-语句.md)
        * [2.2.1 声明语句和变量](221-声明语句和变量.md)
        * [2.2.2 赋值语句](222-赋值语句.md)
        * [2.2.3 cout 的新花样](第2章 开始学习  C++/2_2_3 cout 的新花样.md)
    * [2.3 其他 C++ 语句](23-其他-c-语句.md)
        * [2.3.1 使用 cin](231-使用-cin.md)
        * [2.3.2 使用 cout 进行拼接](232-使用-cout-进行拼接.md)
        * 2.3.3 类简介
    * [2.4 函数](24-函数.md)
        * 2.4.1 使用有返回值的函数
        * 2.4.2 函数变体
...
* [第4章 复合类型](第4章-复合类型.md)
    ...
    * [4.3 string 类简介](43-字符串输入.md)
        * [4.3.1 C++11 字符串初始化](第4章 复合类型/C++11 字符串初始化.md)
        * 4.3.2 赋值、拼接和附加
        * 4.3.3 string 类的其他操作
        * 4.3.4 string 类 I\/O
        * 4.3.5 其他形式的字符串字面值
